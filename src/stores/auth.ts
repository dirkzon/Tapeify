...
export const useAuthStore = defineStore('auth', {
  ...
  getters: {
    userAuthorizationUrl(): URL {
      ...
      searchParams.append('scope', 'user-read-private user-read-email playlist-read-private playlist-modify-public playlist-modify-private user-read-playback-state user-modify-playback-state')
